...
class NearestNeighbourClassifier:
    ...
    def get_probabilities(self, x):
        ...
        for k in range(self.K):
            idx = int(self.labels[neighbours[k]]) - 1
            proportions[idx] += 1
        proportions /= self.K
        return proportions
...
if __name__== "__main__":
    ...
    data = pd.read_csv("/Users/allizha/Desktop/Computer Science/Semester 1/Machine Learning and Data Mining /class.csv")
